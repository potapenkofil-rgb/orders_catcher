"""Нормализация входных данных перед загрузкой файла на Qwen.
...
Идентично betterDeepSeek/files.py — формат достаточно общий, чтобы не
переизобретать его отдельно для каждой библиотеки.
"""
