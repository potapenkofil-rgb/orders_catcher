...
- ТОРГОВЛИ ТОВАРОМ. «Куплю» чего-то готового — это заказ ТОЛЬКО если покупают
  программу: бота, скрипт, парсер, софт. Покупка аккаунтов («куплю акки гугл
  оптом», «дайте макс нерег»), номеров и сим-карт, юрлиц и ИП, АТС и номеров
  8800, подписок и логинов — не заказ, is_order = false, category = "other".
  Перечень операторов, сервисов или цена за штуку — верный признак барахолки
